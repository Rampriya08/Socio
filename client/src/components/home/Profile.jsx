...
const fetchFollowers = async () => {
  try {
    const response = await axios.get(
      `https://socio-ymdb.onrender.com/api/user/${userId}/followers`
    );
...
const fetchFollowing = async () => {
  try {
    const response = await axios.get(
      `https://socio-ymdb.onrender.com/api/user/${userId}/following`
    );
    ...
    const fetchUserFollowingList = async (loggedInUserId) => {
        try {
            const response = await axios.get(`https://socio-ymdb.onrender.com/api/user/${loggedInUserId}/following`);
...
const handleFollowUnfollow = async (username) => {
  try {
    ...
    const fetchProfileData = async (userId) => {
        ...
        try {
            const userResponse = await axios.get(`https://socio-ymdb.onrender.com/api/user/get/${userId}`);
            setUserData(userResponse.data);

            if (activeTab === "posts") {
                const postsResponse = await axios.get(`https://socio-ymdb.onrender.com/api/posts/${userId}/posts`);
                ...
                const followersResponse = await axios.get(`https://socio-ymdb.onrender.com/api/user/${userId}/followers`);
                setFollowers(followersResponse.data);
                fetchProfilePictures(followersResponse.data);
            } else if (activeTab === "following") {
                const followingResponse = await axios.get(`https://socio-ymdb.onrender.com/api/user/${userId}/following`);
    ...
    const fetchMutualFollowers = async (loggedInUserId, profileUserId) => {
        try {
            const response = await axios.get(`https://socio-ymdb.onrender.com/api/user/${loggedInUserId}/mutual-followers/${profileUserId}`);
    ...
    const fetchProfilePictures = async (users) => {
        ...
        const profilePicPromises = users.map(async (user) => {
            try {
                const response = await axios.get(`https://socio-ymdb.onrender.com/api/user/${user}`);
