 ...
 const isDarkMode = theme.palette.mode === "dark";
    ...
    useEffect(() => {
        const fetchUserProfile = async () => {
            ...
            if (user) {
                try {
                    const response = await axios.get(`https://socio-ymdb.onrender.com/api/user/${user.username}`);
    ...
    const handleSubmit = async () => {
      ...
      try {
        const response = await fetch(`https://socio-ymdb.onrender.com/api/posts/add`, {
          method: "POST",
          headers: {
